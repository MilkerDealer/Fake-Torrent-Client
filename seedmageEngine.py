...
class Seeder:
    ...
    def load_peers(self):
        ...
        print(self.info[b"complete"])
        print(self.info[b"incomplete"])
...
if __name__ == '__main__':
    torrentF = File('Big.Daddy.1999.BluRay.1080p.DTS-HD.MA.5.1.AVC.REMUX-FraMeSToR[Fuzer].torrent')
    seed = Seeder(torrentF)
    seed.load_peers()
    """